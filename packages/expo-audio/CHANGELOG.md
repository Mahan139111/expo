...
- [Android] Aligned the default audio focus request on Android 7.0–7.1 with newer versions by using transient exclusive focus when no interruption mode has been configured.

### 🎉 New features

- Added the `doNotMixPersistent` interruption mode.
